...
export const createUser = async (user: { username: string; email: string; phone: string; password: string }) => {
  try {
    const response = await fetch("http://4.240.76.79:3000/api/createUser", {
      method: "POST",
      headers: {
...
export const loginUser = async (credentials: { username: string; password: string }) => {
  try {
    const response = await fetch("http://4.240.76.79:3000/api/login", {
...
export const getUser = async (user_id: string) => {
  ...
  try {
    ...
    const response = await fetch(`http://4.240.76.79:3000/api/getUser?user_id=${user_id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
...
export const getPatient = async (patient_id: string | undefined) => {
  ...
  try {
    // Append userId as a query parameter in the URL
    const response = await fetch(`http://4.240.76.79:3000/api/getPatient?patient_id=${patient_id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
...
export const getDoctor = async (doctor_id: string | undefined) => {
  try {
    // Append userId as a query parameter in the URL
    const response = await fetch(`http://4.240.76.79:3000/api/getDoctor?doctor_id=${doctor_id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
...
export const getRequestDate = async (request_id: string | undefined) => {
  try {
    ...
    const response = await fetch(`http://4.240.76.79:3000/api/getrequests/date?request_id=${request_id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
...
export const getRequestStartTime = async (slot_id: string | undefined) => {
  try {
    const response = await fetch(`http://4.240.76.79:3000/api/getrequests/starttime?slot_id=${slot_id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
...
export const registerPatient = async (patient: Patient) => {
  try {
    ...
    const response = await fetch("http://4.240.76.79:3000/api/patients/register", {
      method: "POST",
